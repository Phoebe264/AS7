...
public class HospitalRoom {
    ...
    public boolean doctorLeave(Doctor d) throws InterruptedException {
        //TODO: implement your code here
        System.out.println("Doctor " + d.name + " Left. number of doctor " + doctor);
        doctor--;
        return true;
    }
    ...
    public boolean patientEnter(Patient p) throws InterruptedException {
        ...
        if (patients < 3) {
            patients++;
            System.out.println("Patient " + p.name + " Entered. number of patients " + patients);
            return true;
        } else {
            System.out.println("Patient " + p.name + " is waiting to Enter. number of patients " + patients);
            Thread.sleep(100);
        }
        return false;
    }
